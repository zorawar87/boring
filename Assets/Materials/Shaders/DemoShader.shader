Shader "Demo/DemoShader"
{
	...
	Properties
	{
        _MeltSpeed ("Melting Speed", Range(0.0, 1.0)) = 0.5
	...
	SubShader
	{
		...
		Tags {
            "Queue" = "Geometry"
            "RenderType"="Opaque" 
        } // other render types are "Transparent" or "Geometry", defines when stuff gets rendered. 

		Pass // A shader can have multible passes. 
        // One pass = one time render everything.
